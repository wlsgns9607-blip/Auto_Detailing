...
> **👨‍💻 개발자 전달사항**
> 
> **ai api 연결로 차종별로 시간 계산하게끔 개발 필요**


**세차의 정석**은 프리미엄 차량 관리에 대한 UX 혁신을 목표로 개발된 **지능형 하이엔드 컨시어지 솔루션**입니다. 단순한 세차 정보 제공을 넘어, '차량 손상 최소화'와 '효율적인 시간/비용 관리'라는 핵심 가치를 제공합니다. 디테일링 실무 경력 2년의 노하우를 데이터화하여, 개인화된 프리미엄 스마트 세차 플랫폼을 기획했습니다.
